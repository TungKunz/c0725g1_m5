...
const EditRoom = ({ facility }) => {
    ...
    const roomSchema = Yup.object().shape({
        ...
        freeService: Yup.string().required("Dịch vụ miễn phí là bắt buộc"),
    });

    const handleSubmit = async (values) => {
        const dataSubmit = { ...values, facilityTypeId: 3 };
        try {
            ...
            <Form className="border p-4 shadow-sm rounded bg-light">
                <div className="row">
                    <div className="col-md-4 mb-3">
                        <label className="form-label fw-bold">Tên Room</label>
                    ...
                    <div className="col-md-12 mt-3 d-flex gap-2">
                        <Button variant="primary" type="submit">Cập nhật Room</Button>
